    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                mstore(0x05a0, 0x00b0c82757582ed2a90cab576a2761cad7c2bb73f7d2e0c8ae605337c98fc559) // vk_digest
                ...
                mstore(0x0880, 0x23587e219f0c5ead69f469bc98bd7c54296f3631bfbead35d934bf0b56726617) // fixed_comms[1].x
                mstore(0x08a0, 0x1731c84dbf74a9e8872108f6134ab42c6fedc952c8a13b0e268f853646ff4fbe) // fixed_comms[1].y
                mstore(0x08c0, 0x2e4f261f643cbe012cd6d872e6b7498e1ebb9f9257229cb5c0b0a210d4e60f6c) // fixed_comms[2].x
                mstore(0x08e0, 0x25c4f7af64ccecf93e96822ae2f793e3e9ccb5f0a516a5d956db282681726afa) // fixed_comms[2].y
                mstore(0x0900, 0x2eac2252f98162ed184e708d161f7d2d1e4586e6be3a7b00fc932f6d40d8773b) // fixed_comms[3].x
                mstore(0x0920, 0x01ae0428a575698f98b368bb821dda4a4ef91379e81bd682da028a88d5a44507) // fixed_comms[3].y
            ...
            // Compute quotient evavluation
            {
                ...
                }
                {
                    ...
                    let input_0
                    {
                        ...
                        let var5 := 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593effff007
                ...
                }
                {
                    ...
                    let input_0
                    {
                        ...
                        let a_4 := calldataload(0x0764)
                        let var8 := mulmod(var1, a_4, r)
                        let var9 := 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593effff84b
                        let var10 := mulmod(var4, var9, r)
                        let var11 := addmod(var8, var10, r)
                        input_0 := var7
                        input_0 := addmod(mulmod(input_0, theta, r), var11, r)
